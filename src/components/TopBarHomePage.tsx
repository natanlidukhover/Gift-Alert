  ...
  return (
    ...
    >
      <View style={{ flex: 0.25, backgroundColor: "black" }}>
        <Image
          source={require("../../assets/presentWhite.png")}
          style={styles.image}
        />
      </View>
      <View style={{ flex: 0.5, backgroundColor: "black" }}>
        <Text style={styles.RecommendationsForText}>
          Recommendations For Contact
        </Text>
      </View>
      <TouchableOpacity
        style={{ flex: 0.25, backgroundColor: "black" }}
        onPress={handleCart}
      >
        <Image
          source={require("../../assets/whiteCartIcon.png")}
          style={styles.image}
        />
      </TouchableOpacity>
    </View>
