...
export default function BottomNav() {
  ...
  return (    
    <View style={{height: 100, backgroundColor: 'powderblue', flexDirection: 'row', flex:1}}>   
        <TouchableOpacity style={{flex:1/3, backgroundColor: 'black'}} onPress= {handleSettings}> 
          <Image source={require('../../assets/settings.png')}style = {styles.image}/>
        </TouchableOpacity>
        <TouchableOpacity style={{flex:1/3, backgroundColor: 'black'}} onPress= {handleHome}> 
          <Image source={require('../../assets/home.png')}style = {styles.image}/>
        </TouchableOpacity>
        <TouchableOpacity style={{flex:1/3, backgroundColor: 'black'}} onPress= {handleContacts}> 
